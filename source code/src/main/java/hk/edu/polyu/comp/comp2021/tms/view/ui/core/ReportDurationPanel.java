...
/**
 * The ReportDurationPanel class extends FormPanel,
 * providing the functionality to report the duration.
 */
public class ReportDurationPanel extends FormPanel {
    private JTextField name;
    private JTextArea area;
    private Box panel;

    /**
     * Constructs a new ReportDurationPane.
     *
     * @param controller the UIController that manages user interactions for the UI
     */
    public ReportDurationPanel(UIController controller) {
        super(controller);
        panel = getContainer();
    ...
    public Result submit() {
        Result result = controller.reportDuration(name.getText());
